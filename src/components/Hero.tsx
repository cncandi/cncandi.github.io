  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden clip-diagonal-bottom bg-brand-navy">
      ...
      <div className="absolute inset-0">
        <Image src="/images/assets/AdobeStock_88942900.jpeg" alt="Industrielle Fertigung" fill className="object-cover opacity-40" priority quality={90} />
        <div className="absolute inset-0 bg-gradient-to-br from-brand-navy via-brand-navy/85 to-brand-blue/40" />
      </div>
      ...
      <div className="absolute top-0 left-0 right-0 h-1 z-20">
        <div className="h-full bg-gradient-to-r from-brand-red via-brand-blue to-transparent" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-40 pb-32 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <Link href="/produkte" className="btn-primary text-base px-8 py-4 shadow-xl shadow-brand-blue/30">
              {t.hero.cta_primary}
        ...
        <div className="hidden lg:block">
          ...
          {/* Decorative element */}
          <div className="absolute -right-8 top-1/3 w-32 h-32 rounded-full border border-brand-blue/20 -z-10" />
          <div className="absolute -right-4 top-1/2 w-16 h-16 rounded-full border border-brand-red/20 -z-10" />
        </div>
      </div>
