...
const products = [
  { key:'sprutcam', href:'/produkte/sprutcam-ency', badge:'Distributor DACH',
    border:'border-brand-teal', accent:'bg-brand-teal', text:'text-brand-teal', glow:'shadow-brand-teal/15',
  ...
  { key:'p3d', href:'/produkte/p3d-slicer', badge:'Eigenentwicklung',
    border:'border-brand-mint', accent:'bg-brand-mint', text:'text-brand-mint', glow:'shadow-brand-mint/15',
  ...
  { key:'solidworks', href:'/produkte/solidworks', badge:'Autorisierter Reseller',
    border:'border-brand-blue', accent:'bg-brand-blue', text:'text-brand-blue', glow:'shadow-brand-blue/15',
    logo:'/images/logos/logo-solidworks.png', image:'/images/solidworks/hero.webp',
    features:['3D-CAD-Marktführer','PDM / Simulation','Schulung & Support'] },
  { key:'delmia', href:'/produkte/delmia-catia', badge:'Dassault Partner',
    border:'border-brand-navy-mid', accent:'bg-brand-navy-mid', text:'text-brand-navy-mid', glow:'shadow-brand-navy/10',
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          {products.map((p, i) => (
            <Link key={p.key} href={p.href} data-reveal data-delay={String(i+1)}
              className={`group flex flex-col bg-white rounded-2xl border-t-4 ${p.border} overflow-hidden card-glow shadow-lg ${p.glow}`}>
              <div className="relative h-48 bg-brand-gray img-zoom">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <span className={`text-sm font-bold flex items-center gap-2 group-hover:gap-3 transition-all ${p.text}`}>
