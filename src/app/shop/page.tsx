...
export default function Page() {
  return (
    <PageLayout title="Shop" subtitle="Software & Lizenzen">
      <section className="py-12 max-w-7xl mx-auto px-6">
        <div className="rounded-xl overflow-hidden border border-brand-teal/20 mb-8">
          <Image src="/images/assets/AdobeStock_88942900.jpeg" alt="Shop" width={1200} height={500} className="w-full object-cover max-h-80" />
        </div>
