...
export default function Page() {
  return (
    <PageLayout title="Forschung & Entwicklung" subtitle="Innovation durch Forschung">
      <section className="py-12 max-w-7xl mx-auto px-6">
        <div className="rounded-xl overflow-hidden border border-brand-teal/20 mb-8">
          <Image src="/images/assets/BMWK.png" alt="Forschung & Entwicklung" width={1200} height={500} className="w-full object-cover max-h-80" />
        </div>
