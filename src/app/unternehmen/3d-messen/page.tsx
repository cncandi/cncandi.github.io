...
export default function Page() {
  return (
    <PageLayout title="3D Messdienstleistung" subtitle="Präzise 3D-Vermessung">
      <section className="py-12 max-w-7xl mx-auto px-6">
        <div className="rounded-xl overflow-hidden border border-brand-teal/20 mb-8">
          <Image src="/images/mockup/3D_Messdienstleistung_02_1229x820.png" alt="3D Messdienstleistung" width={1200} height={500} className="w-full object-cover max-h-80" />
        </div>
