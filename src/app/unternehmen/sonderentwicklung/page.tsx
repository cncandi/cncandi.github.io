  ...
  return (
    <PageLayout>
      <section className="relative bg-brand-navy py-24 overflow-hidden">
        ...
        <div className="absolute inset-0"><Image src="/images/assets/info1.png" alt="Sonderentwicklung" fill className="object-cover opacity-20" /><div className="absolute inset-0 bg-brand-navy/80" /></div>
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h1 className="font-display text-5xl text-white mb-6">Sonderentwicklung</h1>
