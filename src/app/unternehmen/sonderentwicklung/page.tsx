...
export default function Page() {
  return (
    <PageLayout title="Sonderentwicklung" subtitle="Individuelle Softwarelösungen">
      <section className="py-12 max-w-7xl mx-auto px-6">
        <div className="rounded-xl overflow-hidden border border-brand-teal/20 mb-8">
          <Image src="/images/assets/info1.png" alt="Sonderentwicklung" width={1200} height={500} className="w-full object-cover max-h-80" />
        </div>
