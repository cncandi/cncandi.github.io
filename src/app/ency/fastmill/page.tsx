...
export default function Page() {
  return (
    <PageLayout title="Fastmill HPC" subtitle="Hochleistungsfräsen mit Fastmill">
      <section className="py-12 max-w-7xl mx-auto px-6">
        <div className="rounded-xl overflow-hidden border border-brand-teal/20 mb-8">
          <Image src="/images/mockup/Fastmill_HPC_06_902x506.jpg" alt="Fastmill HPC" width={1200} height={500} className="w-full object-cover max-h-80" />
        </div>
